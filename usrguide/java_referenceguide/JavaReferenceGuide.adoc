...
* link:5-mapping_ttcn3_data_types_to_java_constructs.adoc[Mapping TTCNâ€“3 Data Types to {cpp} Constructs]
////
...
include::5-mapping_ttcn3_data_types_to_java_constructs.adoc[leveloffset=+1]
////
