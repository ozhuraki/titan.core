...
[source]
compiler [ -abBcdDeEfFgiIjklLMnNOpqrRstuwxXyY0 ] [ -J file ] [ -K file ] [ -z file ] [ -N old|new ][ -o dir ] [ -V n ] [ -P toplevel pdu ] [ -Qn ] [ -U none|type|"number" ] …[ -T ] module.ttcn [ -A ] module.asn … [ - module.ttcn module.asn … ]
...
[source]
----
usage: makefilegen [-abcdDEfFgGiklLmMnNprRsStTVwWXZ] [-K file] [-P dir]
